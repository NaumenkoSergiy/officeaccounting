...
var ChatPmWindow = (function () {
    function ChatPmWindow(options) {
        ...
        this.options.adapter.server.getUserInfo(this.options.otherUserId, function (userInfo) {
            ...
            chatWindowOptions.title = _this.options.chatName;
            chatWindowOptions.participants_title = I18n.t('conversations.participants');
            chatWindowOptions.canClose = true;
            chatWindowOptions.otherUserId = _this.options.otherUserId.slice();
            ...
            chatWindowOptions.onCreated = function (window) {
                ...
                messageBoardOptions.chatId = _this.options.chatId;
                ...
                messageBoardOptions.otherUserId = new Array();
                messageBoardOptions.otherUserId = _this.options.otherUserId.slice();
