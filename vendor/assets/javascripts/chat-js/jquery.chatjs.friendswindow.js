...
var ChatFriendsWindow = (function () {
    function ChatFriendsWindow(options) {
        ...
        defaultOptions.titleText = I18n.t("conversations.chat_title");
        ...
        chatWindowOptions.onCreated = function (window) {
            ...
            userListOptions.add_to_chat = _this.options.add_to_chat;
            userListOptions.chatClicked = _this.options.chatClicked;
            userListOptions.leaveChatClicked = _this.options.leaveChatClicked;
